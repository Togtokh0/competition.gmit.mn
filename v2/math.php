							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5"><?php echo $lang[$lan]['menu_val'][2][0]; ?></h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100"><?php echo $lang[$lan]['menu_val'][2][0]; ?></a>
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100"><?php echo $lang[$lan]['menu_val'][2][1]; ?></a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
                    ...
                    <div class="card card-custom gutter-b">
											<div class="card-header">
												<div class="card-title">
													<h3 class="card-label">Бодолдгийн сан</h3>
												</div>
											</div>
											<div class="card-body">
												<!--begin::Example-->
												<div class="example">
													<p>Оноор нь нь эмхтгэсэн болно:</p>
													<div class="example-preview">
                            <?php
                            $results_per_page = 9;
                            $sql='SELECT * FROM math_7 ';
                            ...
                            $sql='SELECT * FROM math_7  ORDER BY id DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                            $result = mysqli_query($db, $sql);
                            while($row = mysqli_fetch_array($result)) {
                              ?>
                              <button type="button" class="btn btn-light-primary font-weight-bold mr-2" data-toggle="modal" data-target="#exampleModalSizeXl_<?php echo $row['id']; ?>"><?php echo  $row['date_t']; ?></button>
                              <div class="modal fade" id="exampleModalSizeXl_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeXl" style="display: none;" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Буцах</button>
																				<a class="btn btn-primary font-weight-bold" href="math/<?php echo $row['id']; ?>">Хариу илгээх</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              if($number_of_pages-5>$sn){
                               ...
                               ?>
									...
									<div class="col-lg-3 col-xl-3 pt-5">
										<div class="col-xl-12 card card-custom example example-compact text-center p-5">
											<div id="fb-root" ></div>
