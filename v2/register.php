...
<html lang="en">
	<head><base >
		<meta charset="utf-8" />
		<title>Register байгууллагын бүртгэл</title>
					...
					<div class="d-flex flex-row-fluid flex-center">
						<div class="login-form">
							<form class="form" id="Register"  method="post">
								...
								<a href="register2.php" class="text-primary font-weight-bolder">Би хувь хүн </a></div>

								</div>
								<div class="form-group">
									<input type="text" name="user_type" value="llc" hidden>
									<label class="font-size-h6 font-weight-bolder text-dark">Байгууллагын нэр</label>
								...
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Холбоо барих дугаар</label>
										<input class="form-control h-auto py-4 px-6 rounded-lg border-0" type="number" name="phone" id="phone" autocomplete="off"  />
									<span id="username_error" class="text-danger"></span>
								</div>
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Үйл ажилгааны чиглэл</label>
										<input class="form-control h-auto py-4 px-6 rounded-lg border-0" type="text" name="role_type" id="role_type" autocomplete="off"  />
									<span id="username_error" class="text-danger"></span>
								</div>
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Вэбын холбоос</label>
										<input class="form-control h-auto py-4 px-6 rounded-lg border-0" type="text" name="user_web" id="user_web" autocomplete="off" />
									<span id="username_error" class="text-danger"></span>
								</div>
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Хаяг</label>
										<input class="form-control h-auto py-4 px-6 rounded-lg border-0" type="text" name="address" id="address" autocomplete="off"  />
									<span id="username_error" class="text-danger"></span>
								</div>
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark pt-5">Нууц үг</label>
										<input class="form-control h-auto py-4 px-6 rounded-lg border-0 " type="password" name="password" id="password" />
		      ...
		      $("#Register").on('submit', function(e){
		        ...
		        if($("#username").val() != '' && $("#email").val() !='' && pass_cheke && c_pass_cheke){
		          $.ajax({
					...
					$("#type_the input:checkbox").change(function() {
            alert('ww');
        });
