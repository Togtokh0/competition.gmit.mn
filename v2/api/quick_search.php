...
<div class="quick-search-result">
    ...
    <div class="text-muted d-none">
        ...
        <?php $var = @$_GET['query']; ?>
        <?php
        $t_post="SELECT * FROM news WHERE title_mon LIKE '%".$var."%' ";
        $t_user="SELECT * FROM users WHERE user_name LIKE '%".$var."%' ";
        $t_file="SELECT * FROM problems WHERE name LIKE '%".$var."%' ";
    ...
    <div class="mb-10">
      ...
      <div class="d-flex align-items-center flex-grow-1 mb-2">
            ...
            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                <a href="post.php?id=<?php echo $row["id"]; ?>" class="font-weight-bold text-dark text-hover-primary">
    ...
    <div class="mb-10">
      ...
      <div class="d-flex align-items-center flex-grow-1 mb-2">
            <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                <img src="<?php if($row['photo']=='img_null' || !$row['photo']){
    ...
    <div class="mb-10">
      <?php while ($row = mysqli_fetch_array($file_d)) {  ?>
        <div class="d-flex align-items-center flex-grow-1 mb-2">
              ...
              <div class="d-flex flex-column ml-3 mt-2 mb-2">
                  <a href="problem.php?id=<?php echo $row["id"]; ?>" class="font-weight-bold text-dark text-hover-primary">
                  <?php echo $row['name']; ?>
                  </a>
                  <span class="font-size-sm font-weight-bold text-muted">
