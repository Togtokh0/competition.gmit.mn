...
$id =$_GET['id'];
$use=false;
$results = mysqli_query($db, "SELECT * FROM users where user_id = '$id'");
                      ...
                      <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                          <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                            ...
                            <div class="symbol-label" style="background-image:url('<?php if(@$one_user['photo']=='img_null' || !$one_user['photo']){
                          ...
                          <div>
                            <a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary"><?php echo $one_user['user_name']; ?></a>
                            <div class="text-muted"><?php
                            if($one_user['user_type']=='llc'){
                              echo "Байгуулаг";
                            }
                            if($one_user['user_type']=='school'){
                              echo "Сургууль";
                            }
                             if($one_user['user_type']=='men'){
                              echo "Хувь хүн";
                            } ?></div>
                          </div>
                        </div>
                        ...
                        <div class="py-9">
                          <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <a href="#" class="text-muted text-hover-primary"><?php echo $one_user['user_email']; ?></a>
                          </div>
                          <div class="d-flex align-items-center justify-content-between mb-2">
                            <span class="font-weight-bold mr-2">Утас:</span>
                            <span class="text-muted"><?php echo $one_user['user_phone']; ?></span>
                          </div>
                          <div class="d-flex align-items-center justify-content-between">
                            <span class="font-weight-bold mr-2">Төлөв:</span>
                            <span class="text-muted"><?php echo $one_user['user_role']; ?></span>
                          </div>
                        </div>
                        <!--end::Contact-->
                        <!--begin::Nav-->
                      ...
                      <form class="form">
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                              <div class="image-input image-input-outline"  style="background-image: url(<?php if(@$one_user['photo']=='img_null' || !$one_user['photo']){
          echo $host_url."uploads/logo.png";
        }else{
          echo $one_user['photo'];
        } ?>)">
                                <div class="image-input-wrapper" style="background-image: url(<?php if(@$one_user['photo']=='img_null' || !$one_user['photo']){
            echo $host_url."uploads/logo.png";
          }else{
            echo $one_user['photo'];
          } ?>)"></div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                              <input class="form-control form-control-lg form-control-solid" type="text" value="<?php echo $one_user['user_name']; ?>" />
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 col-form-label text-right">Үйл ажиллагааны чигл</label>
                            <div class="col-lg-9 col-xl-6">
                              <input class="form-control form-control-lg form-control-solid" type="text" value="<?php echo $one_user['role_type']; ?>" />
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                              <div class="input-group input-group-lg input-group-solid">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-solid" value="+976 <?php echo $one_user['user_phone']; ?>" placeholder="Phone" />
                              </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                              <div class="input-group input-group-lg input-group-solid">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-solid" value="<?php echo $one_user['user_email']; ?>" placeholder="Email" />
                              </div>
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                              <div class="input-group input-group-lg input-group-solid">
                                <input type="text" class="form-control form-control-lg form-control-solid" placeholder="link" value="<?php echo $one_user['user_web']; ?>" />
                                <div class="input-group-append">
                                </div>
                              </div>
                            </div>
