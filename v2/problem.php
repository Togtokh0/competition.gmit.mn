...
?>
<?php
  $post_row= mysqli_query($db, "SELECT * FROM problems  where id='$on' limit 1");
 ...
 <?php while ($row_post = mysqli_fetch_array($post_row)) { ?>
   ...
   <html lang="en">
      ...
      <title><?php  echo $title; ?></title>
  		...
  		<meta property="og:description"        content="<?php echo $row_post['dis']; ?>" />
   			...
   			<div class="d-flex flex-row flex-column-fluid page">
   				...
   				<div class="d-flex flex-column flex-row-fluid wrapper " id="kt_wrapper">
                    ...
                    <div class="d-flex flex-column">
                      <!--begin::Title-->
                      <h2 class="text-white font-weight-bold my-2 mr-5" id="timers"></h2>
                      <!--end::Title-->
                      <!--begin::Breadcrumb-->
                      ...
                      <div class="card card-custom gutter-b example example-compact " id="print_post">
                        <div class="card-header ">
                          ...
                          <div class="col-3 p-5">
                            <div class="example-tools justify-content-right ">
                              <h6 class="card-label pr-5"> <small><?php  echo $row_post['upload_date']; ?></small>
                              </h6>
                        ...
                        <div class="card-body " data-wheel-propagation="true">
                          ...
                          <div class="">
                            <?php
                            if($row_post['file']){ ?>
                                <a href="  <?php  echo $host_url.''.$row_post['file']; ?>" class="btn btn-primary btn-block btn-shadow font-weight-bold mr-2 ">Хавсралт файл </a>
                            <?php } ?>
                          </div>
                        </div>
                      </div>
                      <div class="row">
      									<div class="col-lg-12 col-xl-12 pt-5 pb-5">
      										 ...
      										 <div class="card">
      										  <div class="card-header" id="headingOne8">
      										   <div class="card-title" data-toggle="collapse" data-target="#collapseOne8">
      										    <div class="card-label text-warning">Хамрах хүрээ</div>
      										    <span class="svg-icon">
      										     <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
      										      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      										 ...
      										 <!-- <div class="card">
      										  <div class="card-header" id="headingTwo8">
      										   <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo8">
      										    <div class="card-label text-warning">Хэлэлцүүлэг </div>
      										    <span class="svg-icon">
      										     <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
      										      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      										       <polygon points="0 0 24 0 24 24 0 24"></polygon>
      										 ...
      										 <div class="card">
      										  <div class="card-header" id="headingThree8">
      										   <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree8">
      										    <div class="card-label text-warning">Нөхцөл шаардлага</div>
      										    <span class="svg-icon">
      										     <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
      										      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      										       <polygon points="0 0 24 0 24 24 0 24"></polygon>
                      ...
                      <div class="col-xl-12 card card-custom example example-compact text-center p-5 text-center">
                        ...
                        <div class="fb-comments" data-href="<?php echo $actual_link; ?>" data-numposts="5" data-width="600"></div>
   									...
   									<div class="col-lg-3 col-xl-3 pt-5">
   										<div class="col-xl-12 card card-custom  t p-5">
   											<h5>Оруулсан : <?php
                        $un_id=$row_post['user_id'];
  $count= mysqli_query($db, "SELECT * FROM users where user_id='$un_id' ");
                        print_r(mysqli_fetch_array($count)['user_name']); ?></h5>
                        <h5>Хүлээж авасан : <?php
                        $count= mysqli_query($db, "SELECT * FROM res where pro_id='$on' ");
                        $count=(mysqli_num_rows($count));
                         ...
                         $count=1;
                          ...
                          <b> <p><?php echo $count; $count++; ?>. <a href=" <?php echo $host_url.''.$row['url']; ?>"> <?php echo $row['file_name'] ?></a></p></b> 
                           ...
                           <?php } ?>
                          <a href="sent.php?id=<?php echo $on; ?>" class="btn btn-info btn-block btn-shadow font-weight-bold mr-2 ">Шийдэл илгээх </a>
   										</div>
   									</div>
   								</div>
   								<!--end::Dashboard-->
      ...
      var countDownDate = <?php  echo strtotime($row_post['ex_date'] ) ?> * 1000;
     ...
     <?php if($lan=="mon_name"){ ?>
       document.getElementById("timers").innerHTML = ""+days + " өдөр " + hours + " Цаг " +
       minutes + " миниут " + seconds + " секунт ";
       if (distance < 0) {
       clearInterval(x);
        document.getElementById("timers").innerHTML = "Үйл ажиллагаа дууссан";
       }
       <?php }else{ ?>
         document.getElementById("timers").innerHTML = ""+days + " days " + hours + " hours " +
         minutes + " minutes " + seconds + " seconds ";
         if (distance < 0) {
         clearInterval(x);
          document.getElementById("timers").innerHTML = "Ewent completed";
         }
         <?php } ?>
