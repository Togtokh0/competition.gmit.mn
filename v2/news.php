									...
									<div class="col-12  ">
										<div class=" card-custom sticky ">
											<div class="row">
												...
												$sql='SELECT * FROM news  ORDER BY time_s DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
												$result = mysqli_query($db, $sql);
													...
													<div class="col-xl-4 mb-5 ">
														<a href="post.php?id=<?php echo $row['id']; ?>">
															<div class="card card_user">
															 ...
															 <div class="card-body">
																 <center>
																	 <h5 class="card-title text-dark" style=" height: 50px;"><?php echo $row["title_mon"]; ?></h5>
																 </center>
																 <p class="text-info" id="time_r_id_<?php echo $row["id"]; ?>"> <?php  echo $row['time_s']; ?></p>
