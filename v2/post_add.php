							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Post insert</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Post insert</a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
                        ...
                        <!--begin::User-->
												<div class="form-group">
													...
													<div class="form-group">
														 ...
														 <div class="custom-file">
															<input type="file" class="custom-file-input" type="file" name="file"  id="image" />
															<label class="custom-file-label" for="customFile">Файл аа сонгоно уу</label>
														 </div>
														</div>
                    ...
                    <div class="card card-custom card-stretch">
                      ...
                      <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                          <h3 class="card-label font-weight-bolder text-dark">Post insert</h3>
                          <span class="text-muted font-weight-bold font-size-sm mt-1">Мэдээлэл оруулах</span>
                        </div>
                        ...
                        <div class="card-body">
                         ...
                         <div class="form-group">
                          ...
                          <textarea type="text" class="form-control" name="about"id="about" placeholder="Тухай"></textarea>
                           ...
                           <textarea  rows="8" cols="80" class="summernote pt-3" name="body" id="kt_summernote_1"></textarea>
    ...
    <script src="assets/js/pages/crud/forms/editors/summernote.js"></script>
		...
		$.ajax({
				...
				success: function(response){
					...
					if(response.success){
						 alert_center("Пост оруулсан","success");
					}else{
