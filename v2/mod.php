...
<html lang="en">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper " id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid " id="kt_content">
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Problem insert</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Problem insert</a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid ">
							...
							<div class="container">
							  <!--begin::Dashboard-->
                <form id="push" enctype="multipart/form-data" class="d-flex flex-row" action="" method="post">
                        ...
                        <!--begin::User-->
												<div class="form-group">
													 ...
													 <div class="custom-file">
														...
														<label class="custom-file-label" for="customFile">Зурагаа сонгоно уу</label>
													 </div>
													</div>
													<div class="form-group">
														<label>Гарчиг</label>
														<input type="text" class="form-control" name="title" id="title"  placeholder="Гарчиг"/>
												 </div>
												 <div class="form-group">
													 <label>Үнэ</label>
													 <input type="number" class="form-control" name="amount" id="amount"  placeholder="Үнэ"/>
												</div>
												<div class="form-group">
													<label>Дуусах хугцаа</label>
													<input type="date" class="form-control"  name="ex_date" id="ex_date" placeholder=""/>
											 </div>
											 <div class="form-group">
												 <label>Тухай</label>
												 <textarea type="text" class="form-control" name="about"id="about" placeholder="Тухай"></textarea>
											</div>

											<img src="" id="preview" class="img-fluid m-5 " style=" max-width: ;">
                        <!--end::Nav-->
                      </div>
                      <!--end::Body-->
                    </div>
                    ...
                    <div class="card card-custom card-stretch">
                      ...
                      <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                          <h3 class="card-label font-weight-bolder text-dark">Problem insert</h3>
                          <span class="text-muted font-weight-bold font-size-sm mt-1">Асуудалын мэдээлэл оруулах</span>
                        </div>
                        <div class="card-toolbar">
                          <button type="submit" class="btn btn-success " id="submitBtn">Хадгалах</button>
                        </div>
                      </div>
                      <!--end::Header-->
                      <!--begin::Form-->
                      <form class="form">
                        <!--begin::Body-->
                        <div class="card-body">
                           <textarea  rows="8" cols="80" class="summernote" name="body" id="kt_summernote_1"></textarea>
													 <div class="form-group pt-3">
													 	<label>Хамрах хүрээ</label>
													 	<textarea type="text" class="form-control" name="huree"id="about" placeholder="Хамрах хүрээ"></textarea>
													 </div>
													 <div class="form-group ">
													 	<label>Нөхцөл, шаардлага</label>
													 	<textarea type="text" class="form-control" name="nohtsol"id="about" placeholder="Нөхцөл, шаардлага"></textarea>
													 </div>
													 <div class="row">
														 <div class="row col-10" id="uploads_com">
															 <div class="col-6">
															 <div class="form-group">
															 ...
															 <div class="col-6">
																 <div class="form-group">
																		<label>Хавсралт файлын нэр</label>
																		<div class="custom-file">
																			 <input type="text" class="form-control" name="title_1"   placeholder="Жишээ: cv"/>
																		</div>
																	 </div>
															 </div>
														 </div>
														 ...
														 <div class="col-2">
															 <div class="form-group">
																 <label>Мөр нэмэх</label>
																		<div class="custom-file">
																			<input type="text" id="count" name="count_files" value="1" hidden>
																		<input  type="button"   class="btn btn-primary mr-2" id="add" value="Нэмэх">
																	</div>
																 </div>
														 </div>
													 </div>
    ...
    <script src="assets/js/pages/crud/forms/editors/summernote.js"></script>
		...
		$( "#add" ).click(function() {
			com_count++;
			$('#count').val(com_count);
			$( '#uploads_com' ).html($( '#uploads_com' ).html()+`<div class="col-6">
			<div class="form-group">
				 <label>Хавсралт файл</label>
				 <div class="custom-file">
					<input type="file"  name="file_`+com_count+`"   />
			...
			<div class="col-6">
				<div class="form-group">
					 <label>Хавсралт файлын нэр</label>
					 <div class="custom-file">
							<input type="text" class="form-control" name="title_`+com_count+`"   placeholder="Жишээ: cv"/>
					 </div>
					</div>
			</div>`);
		});
		...
		e.preventDefault();
		var body = $('#kt_summernote_1').summernote('code');
		var title = $('#title').val();
		var amount = $('#amount').val();
		var ex_date = $('#ex_date').val();
		var about = $('#about').val();
		var image = $('#image').attr('files');
		$.ajax({
				type: 'POST',
				url: 'input.php',
				...
				success: function(response){
					...
					$('#submitBtn').text('Хадгалах');
					if(response.success){
						 alert_center("Бүртгэгдлээ админ зөвшөөртөл түр хүлээнэ үү","success");
					}else{
