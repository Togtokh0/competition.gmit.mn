...
<html lang="en">
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Илгээх</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Илгээх</a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
							...
							<div class="container">
                              ...
                              if(@$_FILES["file"]["name"]){
                                ...
                                $file='null';
							             ...
							             $math_row = mysqli_query($db, "SELECT * FROM problems WHERE id='$id_s' LIMIT 1");
							             while ($row = mysqli_fetch_array($math_row)) {
							         ?>
  ...
  <script src="https://code.jquery.com/jquery-3.5.0.js"></script>
							            <form class=""  id="push_file" action="sent.php?id=<?php echo $id_s;  ?>" method="post"  enctype="multipart/form-data" >
														<input type="text" name="in_user_id" value="<?php echo $row['user_id']; ?>" hidden>
                            <input type="text" name="id" value="<?php echo $id_s; ?>" hidden>
...
<button  type="submit" name="sent_file" class="btn btn-primary mr-2" id="submitBtn" value="Илгээх">Илгээх</button>
                          ...
                          $.ajax({
                              ...
                              success: function(response){
                                ...
                                if(response.success){
                                  	 alert_center("Бүртгэгдлээ","success");
							        ...
							        <div class="card-body">
							          <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
							            <thead>
							              <tr>
							                <th>Дугаар</th>
							                <th>Бодолдгийн дугаар</th>
							                <th>Файлын зам</th>
							                <th>Явуулсан хугцаа</th>
							              </tr>
							            </thead>
							            <tbody>
							              <?php $orders = mysqli_query($db, "SELECT * FROM res WHERE user_id='$user_id'");
							              $t=1;
							             ?>
							             <?php while ($row = mysqli_fetch_array($orders)) {  ?>
							              <tr>
							                <td> <a href="insert.php?id=<?php echo $row['id']?>"><?php echo $row['id']?></a></td>
							                <td> <a href="problem.php?id=<?php echo $row['pro_id'] ?>"> <?php echo $row['pro_id'] ?></a></td>
							                <td><a href="    <?php echo $host_url.''.$row['file'] ?>">File</a>
                            </td>
							    ...
							    <div class="col-lg-3 col-xl-3 pt-5">
							      <div class="col-xl-12 card card-custom  p-5">
                      <h5>Хавсралт файл</h5>
                      <?php   $math_row = mysqli_query($db, "SELECT * FROM file WHERE problem_id='$id_s'");
                      $count=1;
                       while ($row = mysqli_fetch_array($math_row)) { ?>
                       <b> <p><?php echo $count; $count++; ?>. <a href=" <?php echo $host_url.''.$row['url']; ?>"> <?php echo $row['file_name'] ?></a></p></b>
