							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5"><?php echo $lang[$lan]['menu_val'][3][0]; ?></h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100"><?php echo $lang[$lan]['menu_val'][3][$get_1]; ?></a>
											<!--begin::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
							...
							<div class="container ">
								...
								<div class="row">
									<div class="col-lg-9 col-xl-9  pt-5 ">
										<?php $post_row_e= mysqli_query($db, "SELECT * FROM suppliers group by add_row order by id");
										while ($row_post_e = mysqli_fetch_array($post_row_e)) {
											?>
											<div class="row">
											<h3 class="col-xl-12 text-warning"><?php echo $row_post_e['add_row']; $Roww=$row_post_e['add_row']; ?></h3>
													<?php
			                    $post_row= mysqli_query($db, "SELECT * FROM suppliers WHERE add_row='$Roww' order by id desc ");
