					...
					<div class="d-flex flex-row-fluid flex-center">
						<div class="login-form">
							<form class="form" id="Register"  method="post">
								...
								<a href="register.php" class="text-primary font-weight-bolder">Байгууллагын бүртгэл </a></div>

								</div>
								<div class="form-group">
									<input type="text" name="user_type" value="men" hidden>
									<label class="font-size-h6 font-weight-bolder text-dark">Нэр</label>
								...
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Ажлын газар,сургуул</label>
