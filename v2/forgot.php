...
if (isset($_POST['f_pass'])) {
  $email =$_POST['email'];
  $ck = mysqli_query($db, "SELECT * FROM users WHERE user_email ='$email' ");
  if(mysqli_num_rows($ck)==1){
    function user_id_rand($length = 4) {
    ...
    $html='<div style="max-width:550px; min-width:320px;  background-color: white; border: 1px solid #DDDDDD; margin-right: auto; margin-left: auto;">
      <div style="margin-left:30px;margin-right:30px">
        <p>&nbsp;</p>
        <p><a href=" style="text-decoration:none;font-family:Verdana, Geneva, sans-serif;font-weight: bold; color: #3D3D3D;font-size: 15px">@@@@.mn</a></p>
...
<html lang="en">
    ...
    <?php if($alert){
      ?>
       alert_center("Амжилттай","success",'login.php');
      <?php
    } ?>
