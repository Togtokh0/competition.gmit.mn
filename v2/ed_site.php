                      ...
                      <div class="card-body pt-4">
                        <!--begin::Toolbar-->
												<form id="push">
													...
													<button type="submit" class="btn btn-primary mr-2 block btn-lg btn-block" id="submitButton">Байршуулах</button>
												</form>
	<label>Зураг нь дээр дархад url хуулагдах болно </label>
                        <!--end::Toolbar-->
                        <!--begin::User-->
                        <div class="d-flex align-items-center row">

														<?php
															$results = mysqli_query($db, "SELECT * FROM upload_image");
														 ?>
														 <?php while ($row = mysqli_fetch_array($results)) { ?>
															 <div class="col-6 copyText" onclick="myFunction13('<?php echo $host_url.$row['url']; ?>')" >
																 <div class="symbol symbol-50 symbol-xxl-100 m-5 align-self-start align-self-xxl-center ">
																 <div class="symbol-label" style="background-image:url('<?php echo $host_url.$row['url']; ?>')"></div>
															 </div>
															 </div>
                  ...
                  <div class="flex-row-fluid ml-lg-8">
                    ...
                    <div class="card card-custom card-stretch">
                      <!--begin::Form-->
											<div class="card-body">
                        <form class="form" action="serverV1.php" method="post">
                          <div class="form-group mb-8">
                            <div class="alert alert-custom alert-default" role="alert">
                             <div class="alert-icon"><i class="flaticon-warning text-primary"></i></div>
                             <div class="alert-text">
                              Энэ дээр үйлдэл сайтын хэлбэрийг эвдэх магдлалтайг анхаарна уу !!
                              Color: <?php echo $lang[$lan]['photos']['color']; ?>
                             </div>
                            </div>
                           </div>
                           <div class="form-group">
                            <label>Cover зураг</label>
                            <input type="url" class="form-control" name="bc_image" placeholder="" value="<?php echo $lang[$lan]['photos']['home']; ?>"/>
                            <span class="form-text text-muted">Хэмжээнд нь сайн анхаараарай.</span>
                           </div>
                           <div class="form-group">
                            <label for="exampleInputPassword1">Сайтын өнгө </label>
                            <input type="color" class="form-control" name="bc_color" value="<?php echo $lang[$lan]['photos']['color']; ?>" />
                           </div>
													 <div class="form-group">
														<label for="exampleInputPassword1">Постын нэг нүүрэнд харагдах тоо {нэг мөр obj 3}</label>
														<input type="number" class="form-control" name="page" value="<?php echo $bc_page; ?>" />
													 </div>
                             <input type="submit" class="btn btn-primary" name="pay_user" value="Оруулах" />
...
function myFunction13(copyText){
