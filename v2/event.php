...
?>
<?php
  $post_row= mysqli_query($db, "SELECT * FROM ewent  where id='$on' limit 1");
 ...
 <?php while ($row_post = mysqli_fetch_array($post_row)) { ?>
   ...
   <html lang="en">
   				...
   				<div class="d-flex flex-column flex-row-fluid wrapper " id="kt_wrapper">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->  <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="events.php" class="text-white text-hover-white opacity-75 hover-opacity-100"><?php echo $lang[$lan]['menu_val'][0]; ?></a>
                        <!--end::Item-->
                        <!--begin::Item-->
      ...
      var countDownDate = <?php  echo strtotime($row_post['end_time'] ) ?> * 1000;
