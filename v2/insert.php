...
$id_s=$_GET['id'];
$use=false;
$results = mysqli_query($db, "SELECT * FROM res where id = '$id'");
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5"> <?php  echo pro_id_get($row_post['pro_id'])['name']; ?></h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Ирсэн шийдэл</a>
                      <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100"><?php  echo pro_id_get($row_post['pro_id'])['name']; ?></a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
                    ...
                    <div class="card card-custom gutter-b example example-compact " id="print_post">
                      <div class="card-header ">
                        <div class="card-title col-8">
                          <h3 class="card-label text-center"> <?php  echo pro_id_get($row_post['pro_id'])['name']; ?>
                          </h3>
                        </div>
                        <div class="col-3 p-5">
                          <div class="example-tools justify-content-right ">
                            <h6 class="card-label pr-5"> <small><?php  echo $row_post['in_date']; ?></small>
                            </h6>
