							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Гишүүнчилэлтэй</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Гишүүнчилэлтэй</a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                          ...
                          <div class="navi-item mb-2">
                            <a  class="navi-link py-4  " id="users">
                              ...
                              <span class="navi-text font-size-lg">Оруулсан асуудалууд</span>
                            </a>
                          </div>
													<div class="navi-item mb-2">
                            <a  class="navi-link py-4 " id="asuudal">
                              ...
                              <span class="navi-text font-size-lg">Ирсэн шийдэлүүд</span>
                            </a>
                          </div>
													<!-- <div class="navi-item mb-2">
                            <a  class="navi-link py-4 " id="asuudal2">
                              ...
                              <span class="navi-text font-size-lg">Ажил эхэлсэн</span>
													...
													<div class="navi-item mb-2">
                            <a  class="navi-link py-4 " href="mod.php">
                              <span class="navi-icon mr-2">
                                <span class="svg-icon">
                                  <!--begin::Svg Icon | path:assets/media/svg/icons/General/User.svg-->
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                              ...
                              <span class="navi-text font-size-lg">Асуудал оруулах</span>
                            </a>
                          </div>
                        </div>
                        <!--end::Nav-->
    ...
    document.getElementById("footer_date").innerHTML = d.getFullYear()+" ©";
		...
		var KTDatatableHtmlTableDemo = function() {
			...
			function edit_data(id, text, column_name)
				...
				$(document).on('blur', '.type_2', function(){
						var id = $(this).data("id2");
						var val_2 =$(this).val();
						 $(this).removeAttr("style");
						 if(val_2=="user"){
